...
## server running the MongoDB instance with which you wish to
## connect. If you have chosen to run MongoDB on an alternate port,
...
##
## Modify these values only if you are running a local MongoDB
## instance.
##
